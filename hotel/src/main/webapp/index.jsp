...
<html lang="en">
  <head>
    ...
    <title>Web Design | hotelname</title>
  </head>
  <body>
    <header class="header">
      <nav>
        ...
        <a class="btn nav__btn" href="login.jsp">Book Now</a>
      </nav>
      <div class="section__container header__container" id="home">
        <p>Happy - Unique - Memorable</p>
        <h1>We’re delighted to welcome you<br />To our <span>Hotel</span>.</h1>
        <!---We’re delighted to welcome you to our hotel-->
      </div>
    </header>
    ...
    <section class="section__container about__container" id="about">
      <div class="about__image">
        <img src="assets/rep.jpg" alt="about" />
      </div>
      ...
      <div class="room__grid">
        <div class="room__card">
          <div class="room__card__image">
            <img src="assets/r1.jpg" alt="room" />
          </div>
        ...
        <div class="room__card">
          <div class="room__card__image">
            <img src="assets/r2.jpeg" alt="room" />
          </div>
          <div class="room__card__details">
        ...
        <div class="room__card">
          <div class="room__card__image">
            <img src="assets/r3.jpg" alt="room" />
          </div>
          <div class="room__card__details">
    ...
    <footer class="footer" id="contact">
      <div class="section__container footer__container">
        <div class="footer__col">
          <div class="logo">
            <a href="#home"><img src="assets/image.png"></a>
          </div>
          <p class="section__description">
          ...
          <a class="btn" href="login.jsp">Book Now</a>
        </div>
        <div class="footer__col">
          <h4>QUICK LINKS</h4>
      ...
      <div class="footer__bar">
        Copyright © 2024 Web Site Design. All rights reserved.
      </div>
    </footer>
